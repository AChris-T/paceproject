...
const Register = () => {
  return (
    <div className="flex flex-col gap-8 bg-green-Primary_1 rounded-t-[40px]  px-8 py-8 ">
      ...
      <div className="flex flex-col gap-3">
      <label className="text-[#f2f2f2] text-start font-bold text-[16px]">Phone number</label>
      <input className="bg-transparent border-b-2 font-normal outline-none text-[#FFFFFF]"/>
      </div>
      <div className="flex flex-col gap-3">
      <label className="text-[#f2f2f2] text-start font-bold text-[16px]">Password</label>
      <input className="bg-transparent border-b-2 outline-none font-normal text-[#FFFFFF]"/>
      </div>
      <div className="flex flex-col gap-3">
      <label className="text-[#f2f2f2] text-start font-bold text-[16px]">Confirrm Password</label>
      <input className="bg-transparent border-b-2 outline-none font-normal text-[#FFFFFF]"/>
      </div>
